...
Describe 'Enable-WSLFirewallRule' {
  It 'creates the WSL inbound firewall rule when missing' -Skip {
    # This test requires Pester to mock New-NetFirewallRule, a networking
    # cmdlet that Pester cannot intercept reliably. Marked for integration
    # testing with a real network stack.
...
Describe 'Disable-JetBrainsFirewallRule' {
  It 'disables matching public-profile JetBrains firewall rules' -Skip {
    # This test requires Pester to mock Disable-NetFirewallRule, a networking
    # cmdlet that Pester cannot intercept reliably. Marked for integration
    # testing with a real network stack.
